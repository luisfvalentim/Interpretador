...
public override object VisitFunctionCall(CSubsetParser.FunctionCallContext context)
{
    ...
    // ✅ Verifica se a função chamada é `printf`
    ...
    // ✅ Verifica se a função chamada está armazenada na memória
    ...
    // ✅ Captura os argumentos passados na chamada da função
    ...
    // ✅ Executa o corpo da função e retorna o resultado
    return Visit(functionContext.block());
}
