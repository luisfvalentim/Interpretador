...
statement 
    ...
    | doWhileStatement
    | switchStatement
    | returnStatement  // ✅ Suporte a `return`
    ;

returnStatement : 'return' expression? ';'; // ✅ Mantive aqui para evitar conflitos
...
assignmentExpression : ID ('[' expression ']')? '=' expression; // ✅ Agora também suporta `arr[2] = 10;`
